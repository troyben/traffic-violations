<template>
    <div class="h-screen flex items-center justify-center p-6"
        ...
        <div class="w-full max-w-[500px]">
            <h1 class="text-2xl font-medium mb-4" :style="{ color: isDark ? '#ffffff' : '#333333' }">Payment</h1>
            <p :style="{ color: isDark ? '#e1e1e1' : '#666666' }" class="mb-6">Select your preferred payment method</p>

            <n-card class="mb-6">
                <div class="text-lg mb-4" :style="{ color: isDark ? '#ffffff' : '#333333' }">
                    Payment Summary
                </div>
            ...
            <n-card>
                ...
                <n-button type="primary" block size="large" :style="{
                    ...
                    color: '#000000'
                }" class="mt-6 login-button" :focusable="false" @click="handlePayment">
                    <span class="w-full text-center">Pay Now</span>
                </n-button>
            </n-card>
        </div>
    </div>
...
const handlePayment = () => {
    showSuccess('Payment Success', 'Your payment has been processed')
